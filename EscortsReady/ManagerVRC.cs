...
namespace PermissionEx
{
    public class VRChatService
    {
        ...
        {
            var id = string.Empty;
            if (string.IsNullOrEmpty(Program.Configuration.GetValue<string>("VRCWID")))
                id = "wrld_9cc731f8-2651-41a8-a69f-330da4dfed67";
            id = Program.Configuration.GetValue<string>("VRCWID");
            return id;
        }
        ...
        public static async Task<bool> LoginAsync()
        {
            ...
            config.Username = Program.Configuration.GetValue<string>("VRCU");
            config.Password = Program.Configuration.GetValue<string>("VRCP");
